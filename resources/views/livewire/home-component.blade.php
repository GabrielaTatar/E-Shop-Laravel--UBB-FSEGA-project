				...
				<div class="wrap-products">
					<div class="wrap-product-tab tab-style-1">
						<div class="tab-control">
							<a href="#fashion_1a" class="tab-control-item active">Machiaj</a>
							<a href="#fashion_1b" class="tab-control-item">Ingrijire</a>
							<a href="#fashion_1c" class="tab-control-item">Parfum</a>
						</div>
